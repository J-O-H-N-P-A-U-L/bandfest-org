            ...
            <div className="col-sm-12">
              <div className="bs-component">
                <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
                  <a className="navbar-brand" href="#">bandfest</a>
                  ...
                  <div className="collapse navbar-collapse" id="navbarColor01">
                    <ul className="navbar-nav mr-auto">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="http://www.websitegoodies.com/guestbook.php?a=view&id=930308">Guestbook</a>
                      </li>
                    </ul>
              ...
              <div className="bs-component" style={{marginBottom: '15px'}}>
                <div className="btn-group btn-group-toggle" data-toggle="buttons">
                  <label className="btn btn-primary active">
                    <input type="checkbox" defaultChecked autoComplete="off" /> Active
                  </label>
              ...
              <div className="bs-component">
                <div className="alert alert-dismissible alert-warning">
                  ...
                  <p className="mb-0">Best check yo self, you're not looking too good. Nulla vitae elit libero, a pharetra augue.
                    Praesent commodo cursus magna, <a href="#" className="alert-link">vel scelerisque nisl consectetur et</a>.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="col-sm-4">
              <div className="bs-component">
                <div className="alert alert-dismissible alert-info">
                  <button type="button" className="close" data-dismiss="alert">×</button>
                  <strong>Heads up!</strong> This <a href="#" className="alert-link">alert needs your attention</a>, but it's not
                  super important.
                </div>
              </div>
            </div>
